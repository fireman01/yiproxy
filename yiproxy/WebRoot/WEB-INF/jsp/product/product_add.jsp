...
<form role="form">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control"
			id="shoesRemarks" placeholder="备注">
	</div>
...
function saveProduct(){
	...
	var id = $('#catalogId').val();
	$.post(path+"/product/saveProduct",{brand:shoesBrand,shoesRange:shoesRange,name:shoesName,color:shoesColor,remarks:shoesRemarks,introduction:introduction,picture:picture},function(text){
		if(text!="1"){
			alert("保存失败！");
		}else{
			alert("保存成功！");
